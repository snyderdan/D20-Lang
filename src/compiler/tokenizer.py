...
tokens = [ReTokenFactory('comment',r'//.*'),
          ...
          SingleTokenFactory('v_bar', '|'),
          SingleTokenFactory('comma', ','),
          ...
          SingleTokenFactory('keep_front', 'kf'),
          SingleTokenFactory('keep_rear', 'kr'),
          SingleTokenFactory('discard_high', 'dh'),
          SingleTokenFactory('discard_low', 'dl'),
          SingleTokenFactory('discard_front', 'df'),
          SingleTokenFactory('discard_rear', 'dr'),
